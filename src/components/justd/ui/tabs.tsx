...
const tabsStyles = tv({
  base: 'group flex gap-10 forced-color-adjust-none',
  variants: {
    orientation: {
      horizontal: 'flex-col',
...
const tabStyles = tv({
  base: [
    'relative flex whitespace-nowrap cursor-default items-center rounded-full text-base font-medium outline-none transition hover:text-fg [&>[data-slot=icon]]:size-4 [&>[data-slot=icon]]:mr-2',
    // hor
